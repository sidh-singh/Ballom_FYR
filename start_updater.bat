@echo off
REM ================================================================================
REM === UPDATER LAUNCHER — SILVERM ONLY (dev_update_silver)
REM ================================================================================
REM Usage:  start_updater.bat [demo|live]
REM
REM Reads Fyers token from C:/Ballom_FYR/fyers_token.json (written by dev_scanner).
REM Continuously computes SHA signals for SILVERM only and writes
REM signal_state.json for the dev branch dashboard.
REM Sibling branches: dev_update_nifty (NIFTY), dev_update_gold (GOLDM)
REM
...
echo.
echo ================================================================================
echo              FYERS SHA UPDATER LAUNCHER [SILVERM]
echo ================================================================================
